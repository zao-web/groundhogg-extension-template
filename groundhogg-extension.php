...
define( 'GROUNDHOGG_EXTENSION_ASSETS_PATH', GROUNDHOGG_EXTENSION_PATH . 'build/' );
define( 'GROUNDHOGG_EXTENSION_ASSETS_URL', GROUNDHOGG_EXTENSION_URL . 'build/' );

define( 'GROUNDHOGG_EXTENSION_REQUIRED_WP_VERSION', '5.5' );
define( 'GROUNDHOGG_EXTENSION_REQUIRED_PHP_VERSION', '7.0' );
define( 'GROUNDHOGG_EXTENSION_REQUIRED_CORE_VERSION', '3.0' );
